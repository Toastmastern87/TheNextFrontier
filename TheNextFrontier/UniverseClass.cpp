...
bool UniverseClass::Initialize(D3DClass* direct3D, HWND hwnd, int screenWidth, int screenHeight, float screenDepth, float screenNear)
{
	...
	mPosition->SetPosition(3042.0f, 841.0f, 1428.0f);
